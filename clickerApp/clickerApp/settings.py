"""
Django settings for clickerApp project.
...
SECRET_KEY = 'jrr%8%ftptc3m%p1qs8v_za6ny=)@z-r3bo#-2+#%hwt2h9kt_'
...
STATIC_URL = os.path.join(BASE_DIR, "clickerApp/clickerRoot/static/")
STATIC_ROOT = 'clickerRoot/static/'
STATICFILES_DIRS = (
